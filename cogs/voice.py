...
class voice(commands.Cog):
    ...
    async def setup(self, ctx):
        ...
        id = ctx.author.id
        if ctx.author.id == ctx.guild.owner.id or ctx.author.id == 587391668949483545:
            def check(m):
